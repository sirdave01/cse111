...
# Example 1 - opening and reading text files
def main():
...
# Example 3 - reading a csv files = dentists.txt
import csv
...
# Example 4 - reading a csv into a compound list
import csv
def main():
