# Example 1 - python keywords in handling an exceptions in a program
...
# Example 2 - type error exception
def main():
  try:
...
# Example 3 - value error exception
def main():
  try:
...
# Example 10 - value and zero division error handling
"""
...
# Example 11 - permission and zero division error
import csv
DATE_INDEX = 0
START_MILES_INDEX = 1
END_MILES_INDEX = 2
...
# Example 12 - validating user inputs and handling value errors
def main():
